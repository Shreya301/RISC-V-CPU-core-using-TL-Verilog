...
\TLV
   ...
   $is_r_instr = $instr[6:2] ==? 5'b011x0 || $instr[6:2] == 5'b01100 || $instr[6:2] == 5'b10100;
   ...
   //$funct7_is_valid = $is_r_instr;
   $imm_valid = $is_u_instr || $is_j_instr|| $is_i_instr || $is_s_instr || $is_b_instr;

   `BOGUS_USE($rd $rd_valid $rs1 $rs1_valid $rs2 $rs2_valid $funct3 $funct7 $imm_valid $opcode);
